...
#include <rosserialInc/nav_msgs/GetMapActionFeedback.h>
#include <rosserialInc/nav_msgs/GetMapActionGoal.h>
#include <rosserialInc/nav_msgs/GetMapActionResult.h>
